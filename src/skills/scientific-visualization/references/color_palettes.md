...
```text
figures/.venv Python: scripts/palette_audit.py --palette okabe_ito_on_white --background FFFFFF --role graphical
```

Use the platform-specific `figures/.venv` interpreter command from `SKILL.md`;
do not create an isolated `uv` environment.
