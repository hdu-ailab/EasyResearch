...
| Survival (Cox / log-rank) | Censoring and event-time distribution | Draw event and censoring times and run the exact already-authorized project analysis; this adapted Skill does not install a survival package |
