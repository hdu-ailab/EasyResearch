...
rebuilt.
    ...
    Save a public OpenAlex response, then run: python3 openalex_abstract.py response.json
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog="Save a public OpenAlex response, then run: %(prog)s response.json",
    )
