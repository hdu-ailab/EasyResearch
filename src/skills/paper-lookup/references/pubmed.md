...
Use public unauthenticated E-utilities at no more than 3 requests/second. The
EasyResearch adaptation never adds `api_key`, `tool`, email, or another contact
parameter.
...
- **3 requests/second** through the public unauthenticated route
