...
Use the public pool only. The EasyResearch adaptation never adds `mailto`,
email, keys, or contact details to a query.

## Rate Limits

| Pool | Rate | Concurrency |
|------|------|-------------|
| Public | 5 req/sec | 1 concurrent |
...
**Example:**
```
https://api.crossref.org/works?query=CRISPR+gene+therapy&filter=from-pub-date:2024-01-01,type:journal-article,has-abstract:true&rows=5&sort=published&order=desc
```
