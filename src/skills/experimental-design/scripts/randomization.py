...
def _normalize_ratio(arms, ratio):
    ...
    if any(isinstance(r, bool) or not isinstance(r, Integral) or r <= 0 for r in ratio):
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Reproducible randomization helpers; import the functions for project-specific schedules."
    )
    parser.add_argument("--demo", action="store_true", help="print bounded synthetic examples")
