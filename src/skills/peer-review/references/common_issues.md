...
- **Integrity concern:** credible evidence should be described neutrally with an
  exact locator and routed through the Research Assistant for a user-owned
  journal-process decision.
...
Possible duplication or manipulation should be documented neutrally by location
and assigned to the Research Assistant for user-owned image-integrity routing.
Do not contact an editor or accuse authors of fabrication.
...
If a concern cannot safely be raised in an ordinary correction, state the exact
evidence and uncertainty in the internal Review report and mark it for Research
Assistant/user routing. Do not investigate people, contact institutions/editors,
or reveal the manuscript outside the authorized process.
