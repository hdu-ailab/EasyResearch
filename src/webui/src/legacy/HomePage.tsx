...
/**
 * The pre-refresh Home surface, kept selectable through the `uiVersion`
 * preference. It reads the same session data and API as the current Home page;
 * only the presentation differs.
 */
export function LegacyHomePage({ onOpenSession, settingsButton }: HomePageProps) {
  const { t } = useI18n();
