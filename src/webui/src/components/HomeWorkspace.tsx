      ...
      >
        ...
        >
          <span className="flex min-w-0 items-center gap-3">
            <span
              className={`size-2 shrink-0 rounded-full ${statusDot[session.status]} ${running ? "animate-[v2-pulse_1.6s_ease-in-out_infinite]" : ""}`}
              aria-hidden
            />
        ...
        <SessionRowActions
          ...
          onDisconnect={() => onDisconnectActive(session)}
