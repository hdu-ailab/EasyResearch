...
export const DESKTOP_HOST_PID_ENV = "EASYRESEARCH_DESKTOP_HOST_PID";
export const DESKTOP_HOST_TRANSITION_TOKEN_ENV = "EASYRESEARCH_DESKTOP_HOST_TRANSITION_TOKEN";
export const DESKTOP_TRANSITION_HANDOFF_ENV = "EASYRESEARCH_DESKTOP_TRANSITION_HANDOFF";
